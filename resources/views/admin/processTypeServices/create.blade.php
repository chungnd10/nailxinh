...
<section class="content">
	<div class="box box-default">
		<form action="{{ route('process-type-services.store') }}" method="POST" enctype="multipart/form-data" id="addProcess">
			@csrf
			<div class="box-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" value="{{ old('step') }}" name="step" id="step">
