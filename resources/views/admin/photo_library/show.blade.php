...
@section('content')
    ...
    <section class="content">
        <div class="box box-default">
            <form action="{{ route('photo-library.update', $photo->id) }}"
                  method="POST"
                            ...
                            <div class="form-group">
                                <label class="label" data-toggle="tooltip" title="Thay đổi ảnh">
                                    <img class="rounded profile-user-img img-responsive img-introduction" id="avatar"
                                         src="upload/images/photo_library/{{ $photo->image }}" alt="avatar">
                                ...
                                <select name="type_of_service_id" class="form-control">
                                    @foreach($type_services as $type_of_service)
                                        <option value="{{ $type_of_service->id }}"
                                                @if($type_of_service->id == old('type_of_service_id', $photo->type_of_service_id))
                                                    selected
                                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @foreach($display_status as $item)
                                    <input type="radio"
                                           ...
                                           value="{{ $item->id }}"
                                           @if($item->id == old('display_status_id', $photo->display_status_id))
                                                checked
                                           @endif
                                    >&nbsp;&nbsp;
                                    {{ $item->name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
